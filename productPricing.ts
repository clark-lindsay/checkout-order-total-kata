const ProductDoesNotExistError = new Error('This product is not in the product catalog');

export function getProductPrice(product: string, weight: number = undefined) : number {
